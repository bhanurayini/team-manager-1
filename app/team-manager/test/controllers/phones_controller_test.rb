...
class PhonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post phones_url, params: { phone: { phone_number: @phone.phone_number, phone_type: @phone.phone_type } }
    end
  ...
  test "should update phone" do
    patch phone_url(@phone), params: { phone: { phone_number: @phone.phone_number, phone_type: @phone.phone_type } }
