...
class PaymentTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payment_type" do
    assert_difference('PaymentType.count') do
      post payment_types_url, params: { payment_type: { acct_num: @payment_type.acct_num, cc_num: @payment_type.cc_num, check_num: @payment_type.check_num, payment_type: @payment_type.payment_type, routing_num: @payment_type.routing_num } }
    end
  ...
  test "should update payment_type" do
    patch payment_type_url(@payment_type), params: { payment_type: { acct_num: @payment_type.acct_num, cc_num: @payment_type.cc_num, check_num: @payment_type.check_num, payment_type: @payment_type.payment_type, routing_num: @payment_type.routing_num } }
