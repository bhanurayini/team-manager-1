...
class FeesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fee" do
    assert_difference('Fee.count') do
      post fees_url, params: { fee: { created_on: @fee.created_on, fee_amt: @fee.fee_amt, paid_amt: @fee.paid_amt, paid_on: @fee.paid_on, references: @fee.references } }
    end
  ...
  test "should update fee" do
    patch fee_url(@fee), params: { fee: { created_on: @fee.created_on, fee_amt: @fee.fee_amt, paid_amt: @fee.paid_amt, paid_on: @fee.paid_on, references: @fee.references } }
