...
class CoachesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coach" do
    assert_difference('Coach.count') do
      post coaches_url, params: { coach: { license_exp: @coach.license_exp, license_num: @coach.license_num, person_id: @coach.person_id } }
    end
  ...
  test "should update coach" do
    patch coach_url(@coach), params: { coach: { license_exp: @coach.license_exp, license_num: @coach.license_num, person_id: @coach.person_id } }
